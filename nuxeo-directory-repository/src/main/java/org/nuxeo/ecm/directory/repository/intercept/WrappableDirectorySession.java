...
public interface WrappableDirectorySession {
    ...
    DocumentModel doGetEntry(String id, boolean fetchReferences)
            throws DirectoryException;

    DocumentModel doCreateEntry(Map<String, Object> fieldMap)
            throws ClientException, DirectoryException;

    void doUpdateEntry(DocumentModel docModel) throws ClientException,
            DirectoryException;

    void doDeleteEntry(String id) throws ClientException;

    DocumentModelList doQuery(Map<String, Serializable> filter,
